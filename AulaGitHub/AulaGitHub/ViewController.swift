...
class ViewController: UIViewController {
    ...
    func setupAnime() {
        ...
        anime1.imageCharacter2 = "Newgate"
...
extension ViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: "CellXIB", for: indexPath) as? MyTableViewCellXIB {
            cell.mySetupCellXIB(anime: arrayAnime[indexPath.row])
            return cell
        }
